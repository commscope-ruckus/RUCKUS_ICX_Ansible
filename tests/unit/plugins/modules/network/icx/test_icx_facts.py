...
from ansible_collections.commscope.icx.plugins.modules.network.icx import icx_facts
...
class TestICXFactsModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.commscope.icx.plugins.modules.network.icx.icx_facts.run_commands')
