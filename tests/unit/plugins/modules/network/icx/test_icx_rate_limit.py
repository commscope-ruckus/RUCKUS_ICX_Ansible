...
class TestICXRateLimitModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_exec_command = patch('ansible_collections.commscope.icx.plugins.modules.icx_rate_limit.exec_command')
        # self.mock_run_commands = patch('ansible_collections.commscope.icx.plugins.modules.icx_rate_limit.run_commands')
        self.mock_load_config = patch('ansible_collections.commscope.icx.plugins.modules.icx_rate_limit.load_config')
        self.mock_get_config = patch('ansible_collections.commscope.icx.plugins.modules.icx_rate_limit.get_config')
